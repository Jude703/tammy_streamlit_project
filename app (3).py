...
# 
if not all_chunks:
    st.error("No embedding data found. Please check your JSON files.")
    st.stop()
...
st.markdown("Welcome to your strategic clarity hub. Ask Tammy anything about mindset, growth, or your next move.")
